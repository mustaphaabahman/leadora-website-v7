...
// Wrapper for custom images to fit the icon pattern
const CustomImageIcon = ({ src, alt, className }: { src: string, alt: string, className?: string }) => (
  <div className={`w-full h-full p-2 flex items-center justify-center ${className}`}>
    <Image src={src} alt={alt} width={64} height={64} className="w-full h-full object-contain filter drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]" />
  </div>
);
...
const serviceStyles = [
  {
    ...
    Icon: (props: any) => <CustomImageIcon src="/images/services/lead-gen.jpg" alt="Lead Generation" {...props} className="rounded-xl overflow-hidden" />
  },
  {
  ...
  },
  {
    ...
    Icon: (props: any) => <CustomImageIcon src="/images/services/web-dev.jpg" alt="Web Development" {...props} className="rounded-xl overflow-hidden" />
  },
  {
    // 4. Landing Pages
  ...
  },
  {
    ...
    Icon: (props: any) => <CustomImageIcon src="/images/services/shopify.jpg" alt="Shopify" {...props} className="rounded-xl overflow-hidden mix-blend-screen" />
  },
  {
    // 6. YouCan Stores
  ...
  },
  {
    ...
    Icon: (props: any) => <CustomImageIcon src="/images/services/marketing.jpg" alt="Marketing Consulting" {...props} className="rounded-xl overflow-hidden" />
  }
];
